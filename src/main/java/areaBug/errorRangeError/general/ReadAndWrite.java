...
public class ReadAndWrite {
    ...
    public static void main(String[] args) {
         ...
         */
        //设置文件名称和路径
        String ReadFileName="D:\\Users\\zinanchen\\Desktop\\工作\\面积异常数据\\面积范围异常\\通用刷数\\酒店异常数据明细--1259338426.xlsx";
        //调用方法进行读操作
        ...
        // 设置excel文件路径和文件名称
        String WriteFileName = "D:\\Users\\zinanchen\\Desktop\\工作\\面积异常数据\\面积范围异常\\通用刷数\\面积范围异常数据.xlsx";
